...
'''individueller Dateipfad. Muss angepasst werden, je nachdem wo die Dateien abgespeichert werden sollen'''

f = open("/mnt/c/Uni/Bachelor-Arbeit/prcp_Indices/World/R99p/r99p.csv", 'r')
t = open("/mnt/c/Uni/Bachelor-Arbeit/prcp_Indices/World/R99p/r99p_trend_all.csv", 'w')
t.write("stationid,absolute_increase_per_year, relative_increase_per_year_in_% (absolute_increase / middle_value)\n")
t2 = open("/mnt/c/Uni/Bachelor-Arbeit/prcp_Indices/World/R99p/r99p_trend_recent.csv", 'w')
...
t3 = open("/mnt/c/Uni/Bachelor-Arbeit/prcp_Indices/World/R99p/r99p_trend_comparison.csv", 'w')
t3.write("stationid,absolute_trend_change (trend_recent - trend_all),relative_trend_change_in_5 (absolute_trend_change / middle_value)\n")
...
f = open("/mnt/c/Uni/Bachelor-Arbeit/prcp_Indices/Germany/r99p/r99p_trend_all.csv", 'r')
f2 = open("/mnt/c/Uni/Bachelor-Arbeit/prcp_Indices/Germany/r99p/r99p_trend_recent.csv", 'r')
f3 = open("/mnt/c/Uni/Bachelor-Arbeit/prcp_Indices/Germany/r99p/r99p_trend_comparison.csv", 'r')
row = f.readline()
row2 = f2.readline()
row3 = f3.readline()
while row:
