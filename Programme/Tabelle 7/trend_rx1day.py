...
list_x = []
list_y = []
f = open("/mnt/c/Uni/Bachelor-Arbeit/prcp_Indices/World/Rx1day/Rx1day.csv", 'r')
t = open("/mnt/c/Uni/Bachelor-Arbeit/prcp_Indices/World/Rx1day/Rx1day_trend_all.csv", 'w')
t.write("stationid,absolute_increase_per_year, relative_increase_per_year_in_% (absolute_increase / middle_value)\n")
t2 = open("/mnt/c/Uni/Bachelor-Arbeit/prcp_Indices/World/Rx1day/Rx1day_trend_recent.csv", 'w')
...
t3 = open("/mnt/c/Uni/Bachelor-Arbeit/prcp_Indices/World/Rx1day/Rx1day_trend_comparison.csv", 'w')
...
f = open("/mnt/c/Uni/Bachelor-Arbeit/prcp_Indices/Germany/rx1day/rx1day_trend_all.csv", 'r')
f2 = open("/mnt/c/Uni/Bachelor-Arbeit/prcp_Indices/Germany/rx1day/rx1day_trend_recent.csv", 'r')
f3 = open("/mnt/c/Uni/Bachelor-Arbeit/prcp_Indices/Germany/rx1day/rx1day_trend_comparison.csv", 'r')
row = f.readline()
row2 = f2.readline()
row3 = f3.readline()
while row:
